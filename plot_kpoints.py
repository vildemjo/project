...
force2,drift2,press2,toten2,kdens2 = np.loadtxt("result_k_O_vacancy.txt",unpack=True, skiprows=1)
...
plt.legend()
plt.tight_layout()
plt.savefig("fig/deltatotencurverel_kpoints.pdf")
...
plt.legend()
plt.tight_layout()
plt.savefig("fig/deltaforcepressrel_kpoints.pdf")
plt.show()
