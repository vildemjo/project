...
plot 'DOS27' using 1:2 with lines ls 1 title "LDOS 27 s",     'DOS27' using 1:3 with lines ls 2 title "LDOS 27 p",     'DOS27' using 1:6 with lines ls 3 title "LDOS 27 d"
pause -1

# Uncomment to export eps file
#set term post eps color enhanced
#set output "LDOS27.eps"
#replot
