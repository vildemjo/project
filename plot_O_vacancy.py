...
force2,drift2,press2,toten2,cutoff2 = np.loadtxt("result_O_vacancy.txt",unpack=True, skiprows=1)
...
plt.legend()
plt.tight_layout()
plt.savefig("fig/deltatotencurverel.pdf")
...
plt.legend()
plt.tight_layout()
plt.savefig("fig/deltaforcepressrel.pdf")
plt.show()
